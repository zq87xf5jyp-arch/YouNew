...
def validate_record(
    ...
    media_id_owner: dict,
    *,
    enforce_temporal_currency: bool,
):
    ...
    if record["entity_type"] == "event":
        ...
        if published and enforce_temporal_currency:
...
def main():
    ...
    current_published_release_ids = set(
        effective_release_heads(PROJECT, statuses=("published",))
    )
    ...
    for path in batch_files:
        ...
        for index, record in enumerate(records):
            ...
            validate_record(
                ...
                record_label,
                media_id_owner,
                enforce_temporal_currency=release_id in current_published_release_ids,
            )
            if batch["publication_status"] == "published":
