...
const items = [
  ...
  { href: "/business-inquiries", label: "Бизнес-заявки", icon: Handshake },
    ...
    <aside className="hidden h-screen w-72 shrink-0 border-r border-border/80 bg-[#031023]/95 p-5 lg:sticky lg:top-0 lg:block">
      ...
      <div className="mt-8 rounded-lg border border-cyan-400/20 bg-cyan-400/10 p-4">
        <div className="flex items-center gap-2 text-cyan-100">
          ...
          <p className="text-sm font-semibold">Статус релиза</p>
        </div>
        <p className="mt-2 text-xs text-muted-foreground">Проверяйте подтверждённые критерии и блокеры в разделе «Релизы».</p>
      </div>
