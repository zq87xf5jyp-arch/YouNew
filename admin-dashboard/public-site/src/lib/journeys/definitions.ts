...
export const practicalJourneys = [
  ...
  },
  {
    ...
    guideIds: [],
    coverageNote: "No reviewed work guide is published yet, so YouNew does not show an unverified sequence."
  },
  {
  ...
  },
  {
    ...
    guideIds: [],
    coverageNote: "Use Cities, Map and Emergency today; a reviewed step-by-step guide is not published yet."
  },
  {
