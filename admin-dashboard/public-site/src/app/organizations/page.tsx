...
export default function OrganizationsPage() { return <ContentIndexPage {...listingCopy.organization} entities={getContentEntities("organization")} featuredId="healthcare.amsterdam-umc-location-vumc" />; }
