  ...
  return (
    <PageShell>
      ...
      <div className="section-shell discover-layout">
        ...
        <RecentlyViewed />
        <section className="featured-content" aria-labelledby="featured-title"><div className="listing-heading"><div><h2 id="featured-title">Start with published content</h2><p>Selected from the same reviewed content used by the iOS app.</p></div><Link href="/categories">All categories <ArrowRight aria-hidden /></Link></div><EntityListing entities={featured} /></section>
      </div>
    </PageShell>
  );
}
