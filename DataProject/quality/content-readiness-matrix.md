...
Evidence date: **2026-08-04**. This is a read-only local audit; no live URL check was performed.
...
```bash
python3 scripts/content-readiness-audit.py --as-of 2026-08-04 --check
```
