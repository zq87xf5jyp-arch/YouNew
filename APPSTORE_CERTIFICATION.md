...
| Writable-cache Xcode metadata recovered | With Xcode HOME/cache/module-cache paths moved to `/private/tmp`, `xcodebuild -project YouNew.xcodeproj -list` completed and listed the YouNew target/scheme |
