    ...
    static func localizedItems(_ lang: AppLanguage) -> [SurvivalStarterItem] {
        ...
        case .russian:
            return [
                ...
                item("health", "cross.case.fill", AppColors.gradHealth, "Здоровье без паники", "Сначала различайте: 112 для прямой угрозы жизни, huisarts для обычной медицины, аптека для лекарств.", "Записать местный huisarts/huisartsenpost и аптеку рядом.", "Government.nl", "https://www.government.nl/topics/healthcare"),
        ...
        case .dutch:
            return [
                ...
                item("health", "cross.case.fill", AppColors.gradHealth, "Zorg zonder paniek", "Maak onderscheid: 112 bij levensgevaar, huisarts voor gewone zorg, apotheek voor medicijnen.", "Noteer huisarts/huisartsenpost en apotheek dichtbij.", "Government.nl", "https://www.government.nl/topics/healthcare"),
        ...
        case .english:
            return [
                ...
                item("health", "cross.case.fill", AppColors.gradHealth, "Healthcare without panic", "Separate the routes: 112 for immediate danger, huisarts for regular care, pharmacy for medicine.", "Write down a nearby huisarts/huisartsenpost and pharmacy.", "Government.nl", "https://www.government.nl/topics/healthcare"),
