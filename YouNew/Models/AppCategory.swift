    ...
    static func forPersona(_ persona: PersonaTag?) -> [AppCategory] {
        ...
        case .student:
            return [
                ...
                category(
                    ...
                    destination: .guideSection("housing")
                ),
                category(
                    id: "student-finance",
        ...
        case .worker:
            return [
                ...
                category(id: "worker-employment", titleEN: "Work contracts", titleNL: "Arbeidscontracten", titleRU: "Рабочие контракты", subtitleEN: "Salary, rights, UWV, employment rules", subtitleNL: "Salaris, rechten, UWV, werkregels", subtitleRU: "Зарплата, права, UWV, правила работы", icon: "briefcase.fill", color: AppColors.emerald, destination: .guideSection("work")),
        ...
        case .refugee:
            return [
                ...
                category(id: "refugee-housing-benefits", titleEN: "Housing and benefits", titleNL: "Wonen en uitkeringen", titleRU: "Жилье и пособия", subtitleEN: "Local housing path and support", subtitleNL: "Lokale woonroute en steun", subtitleRU: "Местный путь к жилью и поддержке", icon: "house.fill", color: AppColors.warning, destination: .guideSection("housing")),
        ...
        case .highlySkilledMigrant:
            return [
                ...
                category(id: "hsm-housing", titleEN: "Housing", titleNL: "Wonen", titleRU: "Жилье", subtitleEN: "Renting, registration, utilities", subtitleNL: "Huren, inschrijving, nutsvoorzieningen", subtitleRU: "Аренда, регистрация, коммунальные услуги", icon: "house.fill", color: AppColors.warning, destination: .guideSection("housing"))
            ]
        case .eu:
            return [
                ...
                category(id: "eu-health", titleEN: "Healthcare", titleNL: "Zorg", titleRU: "Медицина", subtitleEN: "Insurance, GP, EHIC questions", subtitleNL: "Verzekering, huisarts, EHIC-vragen", subtitleRU: "Страховка, huisarts, вопросы EHIC", icon: "cross.case.fill", color: AppColors.success, destination: .guideSection("healthcare")),
        ...
        case .tourist:
            return [
                ...
                category(id: "tourist-health", titleEN: "Travel health", titleNL: "Reisgezondheid", titleRU: "Здоровье в поездке", subtitleEN: "Pharmacy, GP, hospital basics", subtitleNL: "Apotheek, huisarts, ziekenhuis", subtitleRU: "Аптека, huisarts, больница", icon: "cross.case.fill", color: AppColors.success, destination: .guideSection("healthcare"))
            ]
        case .entrepreneur:
            return [
        ...
        case .lgbt:
            return [
                ...
                category(id: "lgbt-health", titleEN: "Inclusive healthcare", titleNL: "Inclusieve zorg", titleRU: "Инклюзивная медицина", subtitleEN: "Healthcare, mental health, GP", subtitleNL: "Zorg, mentale gezondheid, huisarts", subtitleRU: "Медицина, психическое здоровье, huisarts", icon: "cross.case.fill", color: AppColors.success, destination: .guideSection("healthcare")),
                category(id: "lgbt-safety", titleEN: "Housing safety", titleNL: "Woonveiligheid", titleRU: "Безопасность жилья", subtitleEN: "Safe housing and legal support", subtitleNL: "Veilig wonen en juridische steun", subtitleRU: "Безопасное жилье и юридическая помощь", icon: "house.fill", color: AppColors.warning, destination: .guideSection("housing")),
