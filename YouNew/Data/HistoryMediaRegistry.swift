...
enum HistoryMediaRegistry {
    ...
    static let images: [AppImageAsset] = [
        ...
        AppImageAsset(
            ...
            url: URL(string: "https://commons.wikimedia.org/wiki/Special:FilePath/De_Nachtwacht.jpg?width=1600"),
            sourcePageURL: URL(string: "https://commons.wikimedia.org/wiki/File:De_Nachtwacht.jpg"),
            imageURL: URL(string: "https://commons.wikimedia.org/wiki/Special:FilePath/De_Nachtwacht.jpg"),
            thumbnailURL: URL(string: "https://commons.wikimedia.org/wiki/Special:FilePath/De_Nachtwacht.jpg?width=1600"),
            originalFileURL: URL(string: "https://upload.wikimedia.org/wikipedia/commons/5/5a/De_Nachtwacht.jpg"),
            ...
            sourceName: "Wikimedia Commons",
            sourceURL: URL(string: "https://commons.wikimedia.org/wiki/File:De_Nachtwacht.jpg"),
