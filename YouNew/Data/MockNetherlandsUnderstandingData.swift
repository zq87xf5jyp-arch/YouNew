...
enum MockNetherlandsUnderstandingData {
    ...
    static let monarchyCards: [CivicInfoCardItem] = [
        ...
        card("monarchy-funded", .monarchy, ("How is the monarchy funded?", "Hoe wordt de monarchie betaald?", "Как финансируется монархия?"), ("Funding is set through public budgets and official arrangements.", "De financiering loopt via publieke begrotingen en officiele regelingen.", "Финансирование определяется через государственный бюджет и официальные правила."), ("The Royal House has budget lines for constitutional duties, staff, and official expenses. Details are published by government sources and can change over time.", "Het Koninklijk Huis heeft begrotingsposten voor constitutionele taken, personeel en officiele kosten. Details worden door overheidsbronnen gepubliceerd en kunnen veranderen.", "У Королевского дома есть бюджетные статьи для конституционных обязанностей, персонала и официальных расходов. Детали публикуются государственными источниками и могут меняться."), "banknote.fill", .intermediate, "https://www.royal-house.nl/topics/themes/monarchy", ["funding", "budget", "royal house", "бюджет"]),
    ...
    static let cultureArticles: [InfoArticle] = [
        ...
        infoArticle(
            ...
            subtitle: infoText("Weekly markets are useful for food, routines, and neighbourhood orientation.", "Weekmarkten zijn handig voor eten, routines en buurtorientatie.", "Еженедельные рынки помогают с едой, привычками и знакомством с районом."),
    ...
    static let cityInfoProfiles: [CityInfoProfile] = {
        let profiles = [
            ...
            cityInfo(
                ...
                summary: infoText("Use Utrecht as a practical base for transport, cycling, municipality registration, healthcare access, and canal-city orientation.", "Gebruik Utrecht als basis voor vervoer, fietsen, inschrijving, zorg en grachtenorientatie.", "Используйте Утрехт как базу для транспорта, велосипеда, регистрации, медицины и ориентации по каналам."),
    ...
    private static func attraction(_ id: String, _ titleEN: String, _ titleNL: String, _ titleRU: String) -> InfoArticle {
        infoArticle(
            ...
            practicalNote: infoText("Use official visitor or water-management sources before choosing a specific dam or museum stop.", "Gebruik officiele bezoekers- of waterbeheerbronnen voordat je een dam of museum kiest.", "Перед выбором дамбы или музея смотрите официальные источники."),
            symbol: "water.waves",
