...
enum CityNewcomerPlacesData {
    ...
    static func firstWeekSteps(for cityId: String, municipalityURL: String?) -> [CityNewcomerGuideItem] {
        return [
            step("register", "building.columns.fill", en: "Check municipality registration", nl: "Controleer registratie bij de gemeente", ru: "Проверьте регистрацию в муниципалитете", den: "Use the official city website for appointments and requirements.", dnl: "Gebruik de officiele stadswebsite voor afspraken en voorwaarden.", dru: "Используйте официальный сайт города для записи и требований.", url: municipalityURL),
            step("insurance", "checkmark.shield.fill", en: "Arrange healthcare basics", nl: "Regel basiszaken voor zorg", ru: "Разберитесь с базовой медициной", den: "Find a GP route and verify health-insurance guidance from official sources.", dnl: "Zoek een huisartsroute en controleer zorgverzekeringsinformatie via officiele bronnen.", dru: "Найдите путь к huisarts и сверяйте информацию о страховке с официальными источниками.", url: "https://www.government.nl/topics/health-insurance"),
            step("digid", "key.fill", en: "Set up DigiD safely", nl: "Stel DigiD veilig in", ru: "Безопасно настройте DigiD", den: "Open DigiD directly from the official domain and avoid unknown links.", dnl: "Open DigiD direct via het officiele domein en vermijd onbekende links.", dru: "Открывайте DigiD только с официального домена и избегайте неизвестных ссылок.", url: "https://www.digid.nl/en"),
    ...
    private static func richPlaces(city: String, officialWebsite: String?) -> [NewcomerPlace] {
        ...
        return [
            ...
            place(city, "documents", .documents, en: "Documents and administration", nl: "Documenten en administratie", ru: "Документы и администрация", den: "Keep official letters, DigiD, appointments, scans, and municipality source links organized. Verify procedures on official domains.", dnl: "Bewaar officiele brieven, DigiD, afspraken, scans en gemeentelijke bronlinks overzichtelijk. Controleer procedures via officiele domeinen.", dru: "Храните официальные письма, DigiD, записи, сканы и ссылки муниципалитета организованно. Проверяйте процедуры на официальных доменах.", url: "https://www.digid.nl/en", source: .official, confidence: .verified, tags: ["DigiD", "documents", "letters", "документы"]),
            ...
            place(city, "work", .work, en: "Work and UWV orientation", nl: "Werk en UWV-orientatie", ru: "Работа и UWV", den: "General direction for work-related public services, official letters, and UWV information. This app does not decide eligibility.", dnl: "Algemene richting voor werkgerelateerde publieke diensten, officiele brieven en UWV-informatie. Deze app bepaalt geen recht op regelingen.", dru: "Общий ориентир по рабочим госуслугам, официальным письмам и UWV. Приложение не определяет право на услуги.", url: "https://www.uwv.nl", source: .publicService, confidence: .verified, tags: ["work", "UWV", "werk", "работа"])
        ]
    }

    private static func fallbackPlaces(cityId: String, municipalityURL: String?) -> [NewcomerPlace] {
        [
            place(cityId, "municipality", .municipality, en: "Municipality services", nl: "Gemeentediensten", ru: "Муниципальные услуги", den: "General guide for registration, address changes, documents, and appointments. Verify the official municipality website.", dnl: "Algemene gids voor inschrijving, verhuizing, documenten en afspraken. Controleer de officiele gemeentesite.", dru: "Общий ориентир по регистрации, смене адреса, документам и записи. Проверяйте официальный сайт муниципалитета.", url: municipalityURL, source: municipalityURL == nil ? .referenceOnly : .municipal, confidence: municipalityURL == nil ? .needsManualVerification : .verified, tags: ["BSN", "gemeente", "регистрация"]),
