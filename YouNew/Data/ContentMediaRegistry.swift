...
enum ContentMediaRegistry {
    static let images: [AppImageAsset] = [
        ...
        AppImageAsset(
            ...
            url: URL(string: "https://commons.wikimedia.org/wiki/Special:FilePath/Amsterdam_centraal_station.JPG?width=1600"),
            sourcePageURL: URL(string: "https://commons.wikimedia.org/wiki/File:Amsterdam_centraal_station.JPG"),
            imageURL: URL(string: "https://commons.wikimedia.org/wiki/Special:FilePath/Amsterdam_centraal_station.JPG"),
            thumbnailURL: URL(string: "https://commons.wikimedia.org/wiki/Special:FilePath/Amsterdam_centraal_station.JPG?width=1600"),
            ...
            sourceName: "Wikimedia Commons",
            sourceURL: URL(string: "https://commons.wikimedia.org/wiki/File:Amsterdam_centraal_station.JPG"),
            creator: "Luu",
            author: "Luu",
            license: "Public domain",
            licenseName: "Public-domain dedication by the copyright holder",
            licenseURL: URL(string: "https://commons.wikimedia.org/wiki/Template:PD-self"),
            attribution: "Luu, via Wikimedia Commons",
            width: 3389,
            height: 2172,
            aspectRatio: 3389.0 / 2172.0,
            type: .transportHero,
            verified: true,
