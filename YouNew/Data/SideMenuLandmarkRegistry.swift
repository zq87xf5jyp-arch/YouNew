...
enum SideMenuLandmarkRegistry {
    static let images: [AppImageAsset] = [
        ...
        landmark(
            ...
            placeName: "Amsterdam",
            aliases: ["Museumplein"],
            fileName: "Rijksmuseum_Amsterdam.jpeg",
            sourcePage: "https://commons.wikimedia.org/wiki/File:Rijksmuseum_Amsterdam.jpeg",
            originalFile: "https://commons.wikimedia.org/wiki/Special:FilePath/Rijksmuseum_Amsterdam.jpeg",
            creator: "olexdj",
            license: "CC BY-SA 4.0",
            licenseName: "Creative Commons Attribution-Share Alike 4.0 International",
            licenseURL: "https://creativecommons.org/licenses/by-sa/4.0/",
            attribution: "olexdj, via Wikimedia Commons",
            width: 3088,
            height: 2056,
